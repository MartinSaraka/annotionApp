...
<S.Content css={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <TabList css={{ _appRegion: 'no-drag', position: 'absolute', left: 0 }} />
        ...
        >
          ...
          >
            <Dialog.Header css={{ borderBottom: '1px solid #ccc' }}>
              <Dialog.Title css={{ color: '#fff', fontSize: '24px', }}>What's New</Dialog.Title>
            </Dialog.Header>
            ...
            <Box
              css={{ display: 'flex', justifyContent: 'flex-end', marginTop: '20px' }}
            >
